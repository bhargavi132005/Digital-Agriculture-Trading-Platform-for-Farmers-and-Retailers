...
export default function RegisterPage() {
  ...
  const inputClass =
    "w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 outline-none transition-all focus:border-green-500 focus:ring-2 focus:ring-green-500/20 text-sm";
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-8 bg-gray-50 dark:bg-gray-950 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link to="/login" className="font-semibold text-green-700 hover:text-green-600 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
